...
CREATE PROCEDURE [dbo].[SSB_RptGetPOSequenceManual]
...
SELECT @PrevTruck			=''	,
	   ...
	   @Wave				=''	,
	   @TruckID				='' ,
	   @SelOrderStatus		='Distributed_OHM'
...
BEGIN	/* Preliminary Data Preparation*/
	...
	INSERT INTO @tblOrderSeq (OrderID,SKU,TruckID,ShipmentDate,ShipmentTime,Wave,UnitType,EstDateTime)
		SELECT o.OrderID		,
			   o.SKU			,
			   o.TruckID		,
			   o.ShipmentDate	,
...
BEGIN   /*  table Data Presentation  */
	INSERT INTO @tblOrdersbySKU (SKU,[Description],[Size],[BedType]	,[CoreType]	,UnitType,Panel	,BorderDec,MU,NoofSides,TruckID,ShipmentDate,ShipmentTime,Wave,intQty,GroupID)
		SELECT	SKU,[Description],[Size],[BedType]	,[CoreType]	,UnitType,Panel	,BorderDec,	ISNULL(MU	,'Pass Through'),NoofSides,TruckID,ShipmentDate,ShipmentTime,Wave,COUNT(OrderID),GroupID
		FROM @tblOrderSeq 
		GROUP BY GroupID,SKU,[Description],[Size],[BedType],[CoreType],UnitType,Panel,BorderDec,MU,NoofSides,TruckID,ShipmentDate,ShipmentTime,Wave	
